function onCreate()
	...
	if not lowQuality then
		makeLuaSprite('dark-numbers1','hazard-week/nums', 0, 0)
		setScrollFactor('dark-numbers1', 0, 0);
		screenCenter('dark-numbers1')
		addLuaSprite('dark-numbers1')
		makeLuaSprite('dark-numbers2','hazard-week/nums', 0, 0)
...
function onSongStart()
	...
	doTweenAlpha('DarkLinesAlpha', 'lines', 1, 5/getProperty('playbackRate'), 'sineInOut')
...
function onBeatHit()
	...
	if songName == 'Pr0cess1ng An0maly' then
		if curBeat == 124 then
			...
			doTweenAlpha('DarkLinesAlpha', 'lines', 0, 0.75/getProperty('playbackRate'), 'sineInOut')
		...
		if curBeat == 128 then
			...
			doTweenAlpha('DarkLinesAlpha', 'lines', 1, 0.15/getProperty('playbackRate'), 'sineInOut')
		...
		if curBeat == 190 then
			...
			doTweenAlpha('DarkLinesAlpha', 'lines', 0, 0.3/getProperty('playbackRate'), 'sineInOut')
		...
		if curBeat == 192 then
			...
			doTweenAlpha('DarkLinesAlpha', 'lines', 1, 0.3/getProperty('playbackRate'), 'sineInOut')
		...
		if curBeat == 672 then
			...
			doTweenAlpha('DarkLinesAlpha', 'lines', 0.65, 0.75/getProperty('playbackRate'), 'sineInOut')
		...
		if curBeat == 735 then
			...
			doTweenAlpha('DarkLinesAlpha', 'lines', 0, 0.5/getProperty('playbackRate'), 'sineInOut')
	...
	if songName == 'Uncontrolled Reaction' then
		if curBeat == 60 then
			...
			doTweenAlpha('DarkLinesAlpha', 'lines', 1, 2/getProperty('playbackRate'), 'sineInOut')
		...
		if curBeat == 63 then
			...
			cancelTween('BGColor')
			doTweenAlpha('DarkLinesAlpha', 'lines', 0, 0.15/getProperty('playbackRate'), 'sineInOut')
		...
		if curBeat == 128 then
			...
			doTweenAlpha('DarkLinesAlpha', 'lines', 1, 0.25/getProperty('playbackRate'), 'sineInOut')
		...
		if curBeat == 204 then
			...
			doTweenAlpha('DarkLinesAlpha', 'lines', 0, 2/getProperty('playbackRate'), 'sineInOut')
		...
		if curBeat == 208 then
			...
			doTweenAlpha('DarkLinesAlpha', 'lines', 1, 0.5/getProperty('playbackRate'), 'sineInOut')
		...
		if curBeat == 334 then
			...
			doTweenAlpha('DarkLinesAlpha', 'lines', 0, 0.25/getProperty('playbackRate'), 'sineInOut')
		...
		if curBeat == 429 then
			...
			doTweenAlpha('DarkLinesAlpha', 'lines', 1, 1/getProperty('playbackRate'), 'sineInOut')
